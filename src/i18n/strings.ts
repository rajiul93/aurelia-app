...
const en = {
  ...
  "prepare.title": "Select your options",
  "prepare.subtitle": "Then tap Download at the bottom",
...
const es: Record<StringKey, string> = {
  ...
  "prepare.title": "Elige tus opciones",
  "prepare.subtitle": "Luego toca Descargar abajo",
...
const fr: Record<StringKey, string> = {
  ...
  "prepare.title": "Choisissez vos options",
  "prepare.subtitle": "Puis appuyez sur Télécharger en bas",
